...
export const updateUserSchema = registerSchema
    ...
    .fork(["Name", "Address", "Password", "MoNumber"], (fields) => fields.optional())
    .fork(["Role", "Email"], (fields) => fields.forbidden())
    .or("Name", "Address", "Password", "MoNumber")
    .messages({
        "object.missing": "Name,Address,and Password any one is required to update"
    })